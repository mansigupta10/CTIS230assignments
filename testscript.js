...
item5 = document.getElementById("classfive");
item6 = document.getElementById("classsix");
item7 = document.getElementById("classseven");
item8 = document.getElementById("classeight");
item9 = document.getElementById("classnine");
item10 = document.getElementById("classten");
item11 = document.getElementById("classeleven");
item12 = document.getElementById("classtwelve");
item13 = document.getElementById("classthirteen");
item14 = document.getElementById("classfourteen");
item15 = document.getElementById("classfifteen");
item16 = document.getElementById("classsixteen");
item17 = document.getElementById("classseventeen");
item18 = document.getElementById("classeighteen");
item19 = document.getElementById("classnineteen");
item20 = document.getElementById("classtwenty");
item21 = document.getElementById("class21");
item22 = document.getElementById("class22");
item23 = document.getElementById("class23");
item24 = document.getElementById("class24");
item25 = document.getElementById("class25");
item26 = document.getElementById("class26");
item27 = document.getElementById("class27");
item28 = document.getElementById("class28");
item29 = document.getElementById("class29");
item30 = document.getElementById("class30");
...
function onButtonClick() {
    ...
    item5.innerHTML = "Grade: A";
    item6.style.color = "red";
    item6.innerHTML = "Grade: A";
    item7.style.color = "red";
    item7.innerHTML = "Grade: A";
    item8.style.color = "red";
    item8.innerHTML = "Grade: A";
    item9.style.color = "red";
    item9.innerHTML = "Grade: A";
    item10.style.color = "red";
    item10.innerHTML = "Grade: A";
    item11.style.color = "red";
    item11.innerHTML = "Grade: A";
    item12.style.color = "red";
    item12.innerHTML = "Grade: A";
    item13.style.color = "red";
    item13.innerHTML = "Grade: A";
    item14.style.color = "red";
    item14.innerHTML = "Grade: A";
    item15.style.color = "red";
    item15.innerHTML = "Grade: A";
    item16.style.color = "red";
    item16.innerHTML = "Grade: A";
    item17.style.color = "red";
    item17.innerHTML = "Grade: A";
    item18.style.color = "red";
    item18.innerHTML = "Grade: A";
    item19.style.color = "red";
    item19.innerHTML = "Grade: B";
    item20.style.color = "red";
    item20.innerHTML = "Grade: A";
    item21.style.color = "red";
    item21.innerHTML = "Grade: A";
    item22.style.color = "red";
    item22.innerHTML = "Grade: A";
    item23.style.color = "red";
    item23.innerHTML = "Grade: A";
    item24.style.color = "red";
    item24.innerHTML = "Grade: A";
    item25.style.color = "red";
    item25.innerHTML = "Grade: A";
    item26.style.color = "red";
    item26.innerHTML = "Grade: A";
    item27.style.color = "red";
    item27.innerHTML = "Grade: A";
    item28.style.color = "red";
    item28.innerHTML = "Grade: A";
    item29.style.color = "red";
    item29.innerHTML = "Grade: A";
    item30.style.color = "red";
    item30.innerHTML = "Grade: A";
    item31.style.color = "red";
    item31.innerHTML = "Grade: A";
    item32.style.color = "red";
...
function onButtonClickReset() {
    ...
    item5.innerHTML = "Honors English II"
    item6.style.color = "";
    item6.innerHTML = "Honors Biology";
    item7.style.color = "";
